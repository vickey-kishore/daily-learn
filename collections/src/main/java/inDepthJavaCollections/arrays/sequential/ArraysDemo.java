package inDepthJavaCollections.arrays.sequential;
...
// arrays from util package ---. core methods (sequential operation)
public class ArraysDemo {
    ...
    private static void sequential() {
        ...
        //strings.remove(0); //throws unsupportedOperationException
        //strings.add("a"); //throws unsupportedOperationException

        strings.set(0, "john"); // but can update,  backed up by original array
    ...
    // Almost sorted array: approx. n comparisons, where n is array size
        ...
        int[] newArray = Arrays.copyOf(iArray, 6); // copy array
